...
if g:plug.ready() && g:env.vimrc.plugin_on
    ...
    " file and directory
    Plug 'steelydylan/vim-shellutils'
    Plug 'steelydylan/mru.vim'
    Plug 'junegunn/fzf'
    ...
    Plug 'steelydylan/vim-ltsv', { 'for': 'ltsv' }
    ...
    Plug '/Users/steelydylan/src/github.com/steelydylan/vim-spacing'

    Plug 'steelydylan/vim-ansible-vault'
    Plug 'christianrondeau/vim-base64'

    " colorscheme
    Plug 'steelydylan/solarized.vim'
    ...
    Plug 'steelydylan/vim-unicode'
    Plug 'steelydylan/vim-sqlfmt'
